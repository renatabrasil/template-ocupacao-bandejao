$( document ).ready(function() {
  ...
  // fisica
  $.get("http://127.0.0.1:8080/fisica/segunda.html", function(data) {
    $("#nav-seg").html(data);
  });
  $.get("http://127.0.0.1:8080/fisica/terca.html", function(data) {
    $("#nav-ter").html(data);
  });
  $.get("http://127.0.0.1:8080/fisica/quarta.html", function(data) {
    $("#nav-qua").html(data);
  });
  $.get("http://127.0.0.1:8080/fisica/quinta.html", function(data) {
    $("#nav-qui").html(data);
  });
  $.get("http://127.0.0.1:8080/fisica/sexta.html", function(data) {
    $("#nav-sex").html(data);
  });
  $.get("http://127.0.0.1:8080/fisica/sabado.html", function(data) {
    $("#nav-sab").html(data);
  });
  $.get("http://127.0.0.1:8080/fisica/domingo.html", function(data) {
    $("#nav-dom").html(data);
  });
