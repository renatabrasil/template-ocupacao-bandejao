$( document ).ready(function() {
  ...
  $.get("http://127.0.0.1:8080/central/segunda.html", function(data) {
    $("#nav-seg").html(data);
  });
  $.get("http://127.0.0.1:8080/central/terca.html", function(data) {
    $("#nav-ter").html(data);
  });
  $.get("http://127.0.0.1:8080/central/quarta.html", function(data) {
    $("#nav-qua").html(data);
  });
  $.get("http://127.0.0.1:8080/central/quinta.html", function(data) {
    $("#nav-qui").html(data);
  });
  $.get("http://127.0.0.1:8080/central/sexta.html", function(data) {
    $("#nav-sex").html(data);
  });
  $.get("http://127.0.0.1:8080/central/sabado.html", function(data) {
    $("#nav-sab").html(data);
  });
  $.get("http://127.0.0.1:8080/central/domingo.html", function(data) {
    $("#nav-dom").html(data);
  });
