$( document ).ready(function() {
  ...
  // quimicas
  $.get("http://127.0.0.1:8080/quimicas/segunda.html", function(data) {
    $("#nav-seg").html(data);
  });
  $.get("http://127.0.0.1:8080/quimicas/terca.html", function(data) {
    $("#nav-ter").html(data);
  });
  $.get("http://127.0.0.1:8080/quimicas/quarta.html", function(data) {
    $("#nav-qua").html(data);
  });
  $.get("http://127.0.0.1:8080/quimicas/quinta.html", function(data) {
    $("#nav-qui").html(data);
  });
  $.get("http://127.0.0.1:8080/quimicas/sexta.html", function(data) {
    $("#nav-sex").html(data);
  });
  $.get("http://127.0.0.1:8080/quimicas/sabado.html", function(data) {
    $("#nav-sab").html(data);
  });
  $.get("http://127.0.0.1:8080/quimicas/domingo.html", function(data) {
    $("#nav-dom").html(data);
  });
